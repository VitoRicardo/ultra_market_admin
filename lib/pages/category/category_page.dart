...
import 'package:ultra_market_admin/pages/common_components/crud_text_field.dart';
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            CrudTextField(onChanged: (value) {}, hintText: 'Name'),
            SizedBox(height: 20.h),
            CrudTextField(onChanged: (value) {}, hintText: 'Description'),
            SizedBox(height: 20.h),
            CrudTextField(
                onChanged: (value) {}, hintText: 'Price', numberPad: true),
            SizedBox(height: 20.h),
